...
## that stores the inverse of a matrix and cache's its reverse.

## The first function, makeCacheMatrix create a special "matrix", 
## which can cache its inverse calculated by the function below.
...
## matrix. However, it first checks to see if the inverse has 
